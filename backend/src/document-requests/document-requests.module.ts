...
@Module({
  imports: [TypeOrmModule.forFeature([DemandeDocument, Document, stagiaire, Gestionnaire]), NotificationsModule],
  controllers: [DocumentRequestsController],
  providers: [DocumentRequestsService, PdfService, FileStorageService],
